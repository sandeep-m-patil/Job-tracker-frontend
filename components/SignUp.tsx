        ...
        <SafeAreaView className="flex-1 ">
            <View className={`flex-1 bg-white ${isDesktop ? 'px-0 h-full' : 'px-6 pt-16 '} h-full`}>
                ...
                <View className={`${isDesktop ? 'flex-row items-center justify-between flex-1 ' : ''}`}>
                    ...
                    {/* Form container */}
                    <View className={`${isDesktop ? 'w-1/2 p-4' : 'w-full'}`}>
                        <View>
                            ...
                            <View className="space-y-4">
                                ...
                                <Text className="text-2xl font-bold text-center mb-8">Create an Account</Text>
                                ...
                                <View className="flex-col flex gap-4 ">
                                    ...
                                    {/* Sign up button */}
                                    <TouchableOpacity className="w-full py-4 rounded-full items-center bg-blue-500"   onPress={() => navigation.navigate('SignUp')}>
